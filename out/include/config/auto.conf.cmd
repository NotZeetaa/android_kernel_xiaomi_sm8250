deps_config := \
	...
	drivers/power/supply/cas_qcom/Kconfig \
	...
	drivers/input/fingerprint/goodix_fod_thy/Kconfig \
	drivers/input/fingerprint/goodix_fod_lmi/Kconfig \
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/root/sm8250_2/clang/bin/aarch64-linux-gnu- --gcc-toolchain=/root/sm8250_2/clang  -Wno-misleading-indentation  -Wno-bool-operation -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
